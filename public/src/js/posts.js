...
var docReady = setInterval(function () {
	...
	var addedCategoryBtn = document.getElementsByClassName('btn')[0];
	addedCategoriesIDs = document.getElementById('categories');
	addedCategoryBtn.addEventListener('click', addCategoryToPost);
...
function removeCategoryFromPost() {
	event.preventDefault();
	even.target.removeEventListener('click', removeCategoryFromPost);
	...
	var newCategoresIDs = categoryIDArray.join(',');
	addedCategoriesIDs.value = newCategoresIDs;
